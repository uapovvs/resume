        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a
                href="mailto:saiduapov48@gmail.com"
      ...
      <footer className="py-10 text-center border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://wa.me/77075510911" className="text-white/30 hover:text-white transition-colors text-sm">WhatsApp</a>
            <a href="mailto:saiduapov48@gmail.com" className="text-white/30 hover:text-white transition-colors text-sm">Gmail</a>
          </div>
        </div>
      </footer>
    </div>
